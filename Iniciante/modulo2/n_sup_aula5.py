...
generos_filmes_escalados = scaler.fit_transform(generos_filmes)
...
gráfico = grupos.plot.bar(subplots=True, #separa o plot dos grupos
                figsize=(70,50), #configura o tamanho da figura
                sharex=False,
...
dados = dados[filtro].sample(5) #aplica o filtro nos dados do filme para 10 amostras
#print(dados)
####

### PLOT DO DENDOGRAMA
#matriz_distancia = linkage(grupos) #define a matriz de distâncias dos pontos para os centroides
#dendograma = dendrogram(matriz_distancia) #usa a matriz de distÂncias para criar e plotar a hierarquia
plt.show()